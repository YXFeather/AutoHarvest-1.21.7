...
public class KeyPressListener {
    ...
    public KeyPressListener() {
        ...
        Identifier General = Identifier.of(CATEGORY_GENERAL);
        Identifier SwitchTo = Identifier.of(CATEGORY_SWITCH_TO);
        KeyBinding.Category categoryGeneral = KeyBinding.Category.create(General);
        KeyBinding.Category categorySwitchTo = KeyBinding.Category.create(SwitchTo);
